    ...
    return (
        <div className=" text-black">
            <div className='container mx-auto'>
                <div className=" w-full lg:w-[580px] mx-auto mt-12 bg-transparent pb-5">
                    <form onSubmit={handleLogin} className="space-y-8 p-5 border">
                        ...
                        <button className="btn bg-gradient-to-r from-[#344281] to-[#9b04ff] text-white hover:text-black text-[18px] w-full capitalize font-semibold">Login</button>
