...
const Login = () => {
    ...
    //         })
    // }
    // bg-[url('https://i.ibb.co/ncZSDCN/data-1084-gambar-login-png-37.jpg')] w-full h-screen bg-cover bg-no-repeat text-black
    return (
        <div className="bg-[url('https://i.ibb.co/vxNB59d/login-bg.png')] w-full h-auto bg-cover bg-no-repeat object-contain pb-12">
